...
/****************************************************************
 Implementation note: This is a function that parses the
 inputted Scheme expression into a conscell structure. The else
 also contains a section that parses the single quote into a
 conscell as if (quote <argument>) had been read in.
 ****************************************************************/
...
/****************************************************************
 Implementation note: This is a private function that converts
 the given list (in conscell structure) to a standard output
